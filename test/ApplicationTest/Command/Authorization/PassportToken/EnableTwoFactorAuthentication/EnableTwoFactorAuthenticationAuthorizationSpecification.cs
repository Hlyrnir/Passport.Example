...
{
    public class EnableTwoFactorAuthenticationAuthorizationSpecification : IClassFixture<PassportFixture>
	{
		private readonly PassportFixture fxtAuthorizationData;
		private readonly ITimeProvider prvTime;

		public EnableTwoFactorAuthenticationAuthorizationSpecification(PassportFixture fxtAuthorizationData)
		{
		...
		public async Task Update_ShouldReturnTrue_WhenPassportIdIsAuthorized()
		{
			...
			IAuthorization<EnableTwoFactorAuthenticationCommand> hndlAuthorization = new EnableTwoFactorAuthenticationAuthorization(fxtAuthorizationData.PassportVisaRepository);
