...
namespace ApplicationTest.Command.Authorization.Passport.SeizePassport
{
    public sealed class SeizePassportAuthorizationSpecification : IClassFixture<PassportFixture>
    {
        ...
        public SeizePassportAuthorizationSpecification(PassportFixture fxtAuthorizationData)
        {
        ...
        public async Task Delete_ShouldReturnTrue_WhenPassportIdIsAuthorized()
        {
            ...
            IAuthorization<SeizePassportCommand> hndlAuthorization = new SeizePassportAuthorization(fxtAuthorizationData.PassportVisaRepository);
