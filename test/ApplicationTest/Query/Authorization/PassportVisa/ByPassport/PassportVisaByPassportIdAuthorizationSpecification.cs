...
{
	public sealed class PassportVisaByPassportIdAuthorizationSpecification : IClassFixture<PassportFixture>
	{
		private readonly PassportFixture fxtAuthorizationData;
		private readonly ITimeProvider prvTime;

		public PassportVisaByPassportIdAuthorizationSpecification(PassportFixture fxtAuthorizationData)
		{
		...
		public async Task Read_ShouldReturnTrue_WhenPassportIdIsAuthorized()
		{
			...
			IAuthorization<PassportVisaByPassportIdQuery> hndlAuthorization = new PassportVisaByPassportIdAuthorization(fxtAuthorizationData.PassportVisaRepository);
