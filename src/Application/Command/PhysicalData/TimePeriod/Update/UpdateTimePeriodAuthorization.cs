...
namespace Application.Command.PhysicalData.TimePeriod.Update
{
    internal sealed class UpdateTimePeriodAuthorization : IAuthorization<UpdateTimePeriodCommand>
	{
		...
		public UpdateTimePeriodAuthorization(IPassportVisaRepository repoVisa)
		{
			this.repoVisa = repoVisa;
		}

		async ValueTask<IMessageResult<bool>> IAuthorization<UpdateTimePeriodCommand>.AuthorizeAsync(UpdateTimePeriodCommand msgMessage, IEnumerable<Guid> enumPassportVisaId, CancellationToken tknCancellation)
		{
