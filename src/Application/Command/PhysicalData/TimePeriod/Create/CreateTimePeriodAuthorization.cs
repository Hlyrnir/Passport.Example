...
namespace Application.Command.PhysicalData.TimePeriod.Create
{
	internal sealed class CreateTimePeriodAuthorization : IAuthorization<CreateTimePeriodCommand>
	{
		...
		public CreateTimePeriodAuthorization(IPassportVisaRepository repoVisa)
		{
			this.repoVisa = repoVisa;
		}

		async ValueTask<IMessageResult<bool>> IAuthorization<CreateTimePeriodCommand>.AuthorizeAsync(CreateTimePeriodCommand msgMessage, IEnumerable<Guid> enumPassportVisaId, CancellationToken tknCancellation)
		{
