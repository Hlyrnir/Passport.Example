...
namespace Application.Command.Authorization.PassportHolder.ConfirmEmailAddress
{
    internal sealed class ConfirmEmailAddressAuthorization : IAuthorization<ConfirmEmailAddressCommand>
	{
		...
		public ConfirmEmailAddressAuthorization(IPassportVisaRepository repoVisa)
		{
			this.repoVisa = repoVisa;
		}

		async ValueTask<IMessageResult<bool>> IAuthorization<ConfirmEmailAddressCommand>.AuthorizeAsync(ConfirmEmailAddressCommand msgMessage, IEnumerable<Guid> enumPassportVisaId, CancellationToken tknCancellation)
		{
