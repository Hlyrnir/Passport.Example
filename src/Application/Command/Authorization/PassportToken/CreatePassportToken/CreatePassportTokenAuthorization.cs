...
namespace Application.Command.Authorization.PassportToken.CreatePassportToken
{
	internal sealed class CreatePassportTokenAuthorization : IAuthorization<CreatePassportTokenCommand>
	{
		...
		public CreatePassportTokenAuthorization(IPassportVisaRepository repoVisa)
		{
			this.repoVisa = repoVisa;
		}

		async ValueTask<IMessageResult<bool>> IAuthorization<CreatePassportTokenCommand>.AuthorizeAsync(CreatePassportTokenCommand msgMessage, IEnumerable<Guid> enumPassportVisaId, CancellationToken tknCancellation)
		{
