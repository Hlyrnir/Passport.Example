...
namespace Application.Command.Authorization.PassportVisa.Delete
{
	internal sealed class DeletePassportVisaAuthorization : IAuthorization<DeletePassportVisaCommand>
	{
		...
		public DeletePassportVisaAuthorization(IPassportVisaRepository repoVisa)
		{
			this.repoVisa = repoVisa;
		}

		async ValueTask<IMessageResult<bool>> IAuthorization<DeletePassportVisaCommand>.AuthorizeAsync(DeletePassportVisaCommand msgMessage, IEnumerable<Guid> enumPassportVisaId, CancellationToken tknCancellation)
		{
