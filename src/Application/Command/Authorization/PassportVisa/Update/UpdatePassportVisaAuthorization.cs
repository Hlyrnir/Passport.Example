...
namespace Application.Command.Authorization.PassportVisa.Update
{
    internal sealed class UpdatePassportVisaAuthorization : IAuthorization<UpdatePassportVisaCommand>
	{
		...
		public UpdatePassportVisaAuthorization(IPassportVisaRepository repoVisa)
		{
			this.repoVisa = repoVisa;
		}

		async ValueTask<IMessageResult<bool>> IAuthorization<UpdatePassportVisaCommand>.AuthorizeAsync(UpdatePassportVisaCommand msgMessage, IEnumerable<Guid> enumPassportVisaId, CancellationToken tknCancellation)
		{
