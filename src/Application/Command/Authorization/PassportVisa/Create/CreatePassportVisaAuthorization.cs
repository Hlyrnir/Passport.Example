...
namespace Application.Command.Authorization.PassportVisa.Create
{
	internal sealed class CreatePassportVisaAuthorization : IAuthorization<CreatePassportVisaCommand>
	{
		...
		public CreatePassportVisaAuthorization(IPassportVisaRepository repoVisa)
		{
			this.repoVisa = repoVisa;
		}

		async ValueTask<IMessageResult<bool>> IAuthorization<CreatePassportVisaCommand>.AuthorizeAsync(CreatePassportVisaCommand msgMessage, IEnumerable<Guid> enumPassportVisaId, CancellationToken tknCancellation)
		{
