...
namespace Application.Query.PhysicalData.TimePeriod.ById
{
    internal sealed class TimePeriodByIdAuthorization : IAuthorization<TimePeriodByIdQuery>
	{
		...
		public TimePeriodByIdAuthorization(IPassportVisaRepository repoVisa)
		{
			this.repoVisa = repoVisa;
		}

		async ValueTask<IMessageResult<bool>> IAuthorization<TimePeriodByIdQuery>.AuthorizeAsync(TimePeriodByIdQuery msgMessage, IEnumerable<Guid> enumPassportVisaId, CancellationToken tknCancellation)
		{
