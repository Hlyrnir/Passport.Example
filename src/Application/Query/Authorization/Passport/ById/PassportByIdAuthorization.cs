...
namespace Application.Query.Authorization.Passport.ById
{
    internal sealed class PassportByIdAuthorization : IAuthorization<PassportByIdQuery>
	{
		...
		public PassportByIdAuthorization(IPassportVisaRepository repoVisa)
		{
			this.repoVisa = repoVisa;
		}

		async ValueTask<IMessageResult<bool>> IAuthorization<PassportByIdQuery>.AuthorizeAsync(PassportByIdQuery msgMessage, IEnumerable<Guid> enumPassportVisaId, CancellationToken tknCancellation)
		{
